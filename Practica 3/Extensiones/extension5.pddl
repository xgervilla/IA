(define (domain extension5)
  ...
  (:functions
    (precio ?plato1 - plato)   ;; precio del plato1
    (calorias ?plato1 - plato) ;; calorias del plato1

    (precioDia ?dia1 - dia)    ;;precio del menu del dia1
    ...
    :effect (and
      ...
      (when
        ...
        (and
          ...
          (increase (precioDia ?dAct) (+ (precio ?plato2) (precio ?platoEsp)))
        )
      )
  ...
  (:action asignaPrimerDia
    ...
    :precondition (and
      ...
      (tipoPlato ?primero ?tipo1)
      (tipoPlato ?segundo ?tipo2)
    )
    ...
    :effect (and
      ...
      (increase (precioDia ?d) (+ (precio ?primero) (precio ?segundo)))
    )
  )
  ...
  (:action asignaRestoDias
    ...
    :parameters (?primero ?segundo - plato ?dAct - dia ?tipo1 ?tipo2 - tipo ?dPrev - dia)
    ...
    :effect (and
      ...
      (increase (precioDia ?dAct) (+ (precio ?primero) (precio ?segundo)))
    )
  )
