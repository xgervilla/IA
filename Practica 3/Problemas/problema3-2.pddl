(define (problem problema3-2)
  ...
  (:init
    ...
    (platoDiaEspecial cuscus lunes)
    (platoDiaEspecial merluza_en_salsa lunes)

    (platoDiaEspecial macarrones martes)
    (platoDiaEspecial hamburguesa_vegetariana martes)

    (platoDiaEspecial gazpacho miercoles)
    (platoDiaEspecial canelones miercoles)

    (platoDiaEspecial paella jueves)
    (platoDiaEspecial lubina_al_horno jueves)

    (platoDiaEspecial ensalada_cesar viernes)
